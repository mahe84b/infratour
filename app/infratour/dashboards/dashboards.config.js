(function() {
    ...
    function moduleConfig($translatePartialLoaderProvider, $stateProvider, triMenuProvider) {
        $translatePartialLoaderProvider.addPart('app/infratour/dashboards');
        ...
        .state('triangular.admin-default.dashboard-general', {
            ...
            templateUrl: 'app/infratour/dashboards/general/dashboard-general.tmpl.html'
        })
        .state('triangular.admin-default.dashboard-analytics', {
            url: '/dashboards/analytics',
            templateUrl: 'app/infratour/dashboards/analytics/dashboard-analytics.tmpl.html',
            controller: 'DashboardAnalyticsController',
            controllerAs: 'vm'
        })
        .state('triangular.admin-default.dashboard-server', {
            url: '/dashboards/server',
            templateUrl: 'app/infratour/dashboards/server/dashboard-server.tmpl.html',
            controller: 'DashboardServerController',
            controllerAs: 'vm'
        })
        .state('triangular.admin-default.dashboard-widgets', {
            url: '/dashboards/widgets',
            templateUrl: 'app/infratour/dashboards/widgets.tmpl.html'
        })
        .state('triangular.admin-default.dashboard-social', {
            url: '/dashboards/social',
            templateUrl: 'app/infratour/dashboards/social/dashboard-social.tmpl.html',
        ...
        .state('triangular.admin-default.dashboard-sales', {
            ...
            views: {
                '': {
                    templateUrl: 'app/infratour/dashboards/sales/dashboard-sales.tmpl.html',
                    controller: 'DashboardSalesController',
                    controllerAs: 'vm'
                },
                'belowContent': {
                    templateUrl: 'app/infratour/dashboards/sales/fab-button.tmpl.html',
        ...
        .state('triangular.admin-default.dashboard-draggable', {
            ...
            templateUrl: 'app/infratour/dashboards/dashboard-draggable.tmpl.html',
